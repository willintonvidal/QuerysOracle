...
/*Insert into CENTRO_EDUCATIVO (CEN_EDU_NIT,CEN_EDU_NOMBRE,CEN_EDU_CIUDAD,CEN_EDU_TELEFONO,CEN_EDU_DIRECCION) values ('1066','Cristo Rey','Popayán','312','Calle 20');
...
insert into MATERIA (MAT_ID,MAT_NOMBRE,GRA_ID,PROF_ID) values ('1403','Matemáticas','2','1061777');
...
Insert into ACTIVIDAD_EVALUATIVA (ACT_EVA_ID,TEM_ID,MAT_ID,ACT_EVA_NOMBRE,ACT_EVA_FECHA_INICIO,ACT_EVA_FECHA_FIN,ACT_EVA_OBSERVACION,ACT_EVA_FOTO) values ('54551','11338','1403','Restas Básicas',to_date('12/02/19','DD/MM/RR'),to_date('12/02/19','DD/MM/RR'),'Restas de números',null);
Insert into ACTIVIDAD_EVALUATIVA (ACT_EVA_ID,TEM_ID,MAT_ID,ACT_EVA_NOMBRE,ACT_EVA_FECHA_INICIO,ACT_EVA_FECHA_FIN,ACT_EVA_OBSERVACION,ACT_EVA_FOTO) values ('54550','11338','1403','Sumas Básicas',to_date('12/02/19','DD/MM/RR'),to_date('12/02/19','DD/MM/RR'),'Sumas de números ',null);
Insert into ACTIVIDAD_EVALUATIVA (ACT_EVA_ID,TEM_ID,MAT_ID,ACT_EVA_NOMBRE,ACT_EVA_FECHA_INICIO,ACT_EVA_FECHA_FIN,ACT_EVA_OBSERVACION,ACT_EVA_FOTO) values ('54552','11338','1403','Multiplicaciones básicas',to_date('12/02/19','DD/MM/RR'),to_date('12/02/19','DD/MM/RR'),'Multiplicaciones de números',null);
